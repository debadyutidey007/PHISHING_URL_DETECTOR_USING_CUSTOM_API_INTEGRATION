...
const generatePdf = (result, url, apiKey)=>{
    ...
    let y = 0;
    const addHeader = ()=>{
        doc.setFillColor(231, 235, 249); // Light primary background
        doc.rect(0, 0, docWidth, 60, 'F');
        doc.setFontSize(24);
        doc.setFont('helvetica', 'bold');
        doc.setTextColor(30, 41, 59); // Primary foreground
        doc.text("PhishNet API", docWidth / 2, 30, {
            align: 'center'
        });
        doc.setFontSize(12);
        doc.setFont('helvetica', 'normal');
        doc.setTextColor(100, 116, 139); // Muted foreground
        doc.text("Advanced Phishing URL Analysis Report", docWidth / 2, 45, {
            align: 'center'
        });
        y = 75;
    };
    const addFooter = ()=>{
        ...
        for(let i = 1; i <= pageCount; i++){
            ...
            doc.text(`Page ${i} of ${pageCount}`, docWidth / 2, doc.internal.pageSize.getHeight() - 15, {
                align: 'center'
            });
            doc.text(`Report generated on ${new Date().toLocaleString()}`, 20, doc.internal.pageSize.getHeight() - 15);
        }
    };
    const addSectionTitle = (title)=>{
        ...
        doc.line(20, y, docWidth - 20, y);
        y += 15;
    };
    const addText = (text, x, yPos, options = {})=>{
        const splitText = doc.splitTextToSize(text, docWidth - x - 20);
        const lineHeight = doc.getLineHeight() / doc.internal.scaleFactor;
        const textHeight = splitText.length * lineHeight;
        y = addNewPageIfNeeded(y + textHeight);
        doc.setFontSize(options.fontSize || 10);
        doc.setFont('helvetica', options.fontStyle || 'normal');
        doc.setTextColor(options.color ? options.color[0] : 80, options.color ? options.color[1] : 80, options.color ? options.color[2] : 80);
    ...
    const addKeyValue = (key, value)=>{
        ...
        const splitText = doc.splitTextToSize(fullText, docWidth - 40);
        const textHeight = splitText.length * (doc.getLineHeight() / doc.internal.scaleFactor) + 5;
        y = addNewPageIfNeeded(y + textHeight);
        doc.setFontSize(10);
        doc.setFont('helvetica', 'bold');
        ...
        doc.text(valueText, 25 + doc.getStringUnitWidth(keyText) * 10, y); // Position value after key
        y += textHeight;
    };
    const addNewPageIfNeeded = (yPos)=>{
        if (yPos > doc.internal.pageSize.getHeight() - 40) {
            doc.addPage();
            addHeader();
            return 75; // Reset y position after header
        }
        return yPos;
    };
    addHeader();
    ...
    addKeyValue("URL Analyzed", url);
    addKeyValue("API Key Used", "********"); // Mask API key for security
    ...
    doc.text(`Prediction: ${result.prediction.charAt(0).toUpperCase() + result.prediction.slice(1)}`, 25, y);
    doc.setTextColor(0);
    y += 12;
    addKeyValue("Confidence Score", `${(result.confidenceScore * 100).toFixed(0)}%`);
    addText(result.overallAssessment, 25, y, {
        fontStyle: 'italic',
        color: [
            100,
            116,
    ...
    addSectionTitle("Threat Categorization");
    addKeyValue("Category", result.threatCategorization.category);
    addText(result.threatCategorization.description, 25, y);
    // --- Detailed Analysis ---
    addSectionTitle("Detailed URL Analysis");
    addKeyValue("Domain Analysis", result.detailedAnalysis.domainAnalysis);
    addKeyValue("Subdomain Analysis", result.detailedAnalysis.subdomainAnalysis);
    addKeyValue("Path Analysis", result.detailedAnalysis.pathAnalysis);
    addKeyValue("Character Analysis", result.detailedAnalysis.characterAnalysis);
    // --- Security Checklist ---
    addSectionTitle("Security Checklist");
    addKeyValue("Uses HTTPS", `${result.securityChecklist.usesHttps.value ? 'Yes' : 'No'}. ${result.securityChecklist.usesHttps.assessment}`);
    addKeyValue("Valid SSL Certificate", `${result.securityChecklist.sslCertificate.valid ? 'Yes' : 'No'}. ${result.securityChecklist.sslCertificate.assessment}`);
    addKeyValue("Domain Reputation", `${result.securityChecklist.domainReputation.status.charAt(0).toUpperCase() + result.securityChecklist.domainReputation.status.slice(1)}. ${result.securityChecklist.domainReputation.assessment}`);
    // --- Actionable Recommendations ---
    addSectionTitle("Actionable Recommendations");
    addKeyValue("Recommended Action", result.actionableRecommendations.userAction);
    addKeyValue("Security Tip", result.actionableRecommendations.securityTip);
    addFooter();
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CardHeader"], {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CardDescription"], {
                                        children: "Review your past analysis results from this session."
                                    }, void 0, false, {
                                        fileName: "[project]/src/components/detector.tsx",
                                        lineNumber: 267,
                                        columnNumber: 21
                                            ...
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$accordion$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AccordionTrigger"], {
                                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                className: "font-semibold truncate w-60 sm:w-80",
                                                                children: item.url
                                                            }, void 0, false, {
                                                                fileName: "[project]/src/components/detector.tsx",
                                                                lineNumber: 277,
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CardContent"], {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        ...
                        children: "All systems are operational. The API is running and accessible."
                    }, void 0, false, {
                        fileName: "[project]/src/components/health.tsx",
                        lineNumber: 35,
                        columnNumber: 9
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        errors.key && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["TableBody"], {
                                    children: apiKeys.map((apiKey)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["TableRow"], {
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["TableCell"], {
                                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$badge$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Badge"], {
                                                        variant: apiKey.expiresIn === 0 ? "secondary" : "outline",
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e80206d5._.js.map